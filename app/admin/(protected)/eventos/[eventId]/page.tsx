        ...
        <section className="panel-card rounded-xl p-4 space-y-4">
          ...
          {hasCourts ? (
            <>
              ...
              <form action={addCourtAction} className="flex flex-wrap gap-2 pt-2 border-t border-neutral-200 dark:border-neutral-800">
                <input
                  name="name"
                  required
                  placeholder="Cancha extra"
                  className="flex-1 min-w-[140px] rounded-md panel-input px-3 py-2 text-sm"
                />
                <select
                  name="discipline_id"
                  defaultValue=""
                ...
                <button
                  type="submit"
                  className="rounded-md panel-button-primary font-medium px-4 py-2 text-sm transition-colors"
                >
                  Agregar otra
                </button>
            ...
            {!hasCourts && (
              <div className="rounded-md border border-brand-orange/40 bg-brand-orange/10 p-3 space-y-2">
                ...
                <p className="text-xs panel-label">
                  Se comparten entre torneos de la misma disciplina — se cargan acá, al crear este
                  primer torneo, con la disciplina que elijas abajo. Después podés sumar más o
                  recolorear cada una desde la pestaña Canchas.
                </p>
                <input
                  name="court_count"
                  type="number"
